                            ...
                            <div class="row mb-3">
	                         ...
	                         ?>
            					<div class="col-sm-8 text-secondary">
            					    <form action="adminprofupdatedbio.php?uID=<?php echo $row['uID']; ?>" method="post">
            						    <p><input type="text" class="form-control" name="bio" value="<?php echo $row['uBio']; ?>"></p>
                                        <button type="submit" style="border: none;"><a class="btn-success btn">Save</a></button>
                                        <a class="button_red btn" href="deletebioadm.php?uID=<?php echo $row['uID']; ?>" type="reset">Reset</a>
                                        <a class="btn-warning btn" href="adminprof.php">Cancel</a> 
                                        </form>
            					</div>
            				</div>
                        </div>
