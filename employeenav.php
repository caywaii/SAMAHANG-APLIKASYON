    ...
    <nav class="sidebar">
        <header>
            <div class="image-text">
                <span class="image">
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Employee_Picture" class="rounded-circle" width="150">
                </span>
            ...
            <div class="menu">
                    ...
                    <div id="accordion">
                                <li class="nav-link" data-bs-toggle="collapse" href="#collapseOne">
                                    <a href="#">
                                        <i class="bi bi-person-lines-fill icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Member Panel"></i>
                            ...
                            <div id="collapseOne" class="collapse" data-bs-parent="#accordion">
                                <li class="nav-link">
                                    <a href="memregforemplo.php">
                                        <i class="bi bi-file-earmark-person icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Register Member"></i>
                                        <span class="text nav-text">Register Member</span>
                                    </a>
                                </li>
                                <li class="nav-link">
                                    <a href="deletedusermember.php">
                                        <i class="bi bi-person-x-fill icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Deleted Member"></i>
                                        <span class="text nav-text">Deleted Member</span>
                                    </a>
                                </li>
                            </div>
                    <li class="nav-link">
                        <a href="accdetails.php">
                            <i class="bi bi-database-add icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Account Details"></i>
                            <span class="text nav-text">Account Details</span>
                        </a>
                    </li>
                    <div class="mt-3">
                            <div id="accordion">
                            ...
                            <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
                                <li class="nav-link">
                                    <a href="transdetail.php">
                                        <i class="bi bi-terminal-plus icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Input Transaction"></i>
                                        <span class="text nav-text">Input Transaction</span>
                                    </a>
                                </li>
                                <li class="nav-link">
                                    <a href="recordforemp.php">
                                ...
                                <li class="nav-link">
                                    <a href="deletedreports.php">
                                        <i class="bi bi-clipboard-x icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Deleted Reports"></i>
                                        <span class="text nav-text">Deleted Reports</span>
                                    </a>
                                </li>
                                <li class="nav-link">
                                    <a href="loanforemp.php">
