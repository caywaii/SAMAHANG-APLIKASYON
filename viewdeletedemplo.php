...
<body style="background: #E4E9F7;">
    <section class="member-reg">
        ...
        <div id="mem_reg" class="text" style="color: #554977;">View Employee</div>
        <hr class="border-3 opacity-75" style="color: #7A47EA;">
        <div id="member_regis" class="text text-center" style="color: #554977;">Deleted Employee Information</div>
            <div class="container">
                </br></br>
                    <div class="col-md-11">
                        <a href="deleteduseremployee.php"><button type="button" class="btn btn-danger my-4 col-md-1">Back</button></a>
                    </div>
               <div class="row g-3">
