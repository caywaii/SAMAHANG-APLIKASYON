...
<body style="background: #E4E9F7;">
    <section class="member-reg">
        ...
        <div id="member_regis" class="text text-center" style="color: #554977;">Update Member</div>
         ...
         <!-- update modal -->
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="border-radius: 1vh;">
                          ...
                          <div class="modal-footer" style="background-color: #d5dff7;">
                            <a href="memregforemplo.php?<?php echo $row['uID']?>"><button type="submit" class="btn btn-primary">Yes</button></a>
            ...
            <div class="container">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md py-3">
                        <div class="form-floating">
                            <input type="number" name="cnum" class="form-control" value="<?php echo $row['uContactNum']; ?>" id="contactnum" placeholder="#" min="11" onKeyPress="if(this.value.length==11) return false;" required>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md py-3">
                        <div class="form-floating">
                            <input type="number" name="zipcode" class="form-control" value="<?php echo $row['uZipCode']; ?>" id="zipc" placeholder="#" min="4" onKeyPress="if(this.value.length==4) return false;" required>
                ...
                <div class="row g-3">
                    ...
                    <div class="row col-md-5" style="float: right;">
                        <div class="">
                            <button type="button" class="btn button_blue my-4 col-md-4" data-bs-toggle="modal" data-bs-target="#update" data-bs-whatever="@getbootstrap">Update</button>
                        </div>
                    </div>
                </div>
            </div>
