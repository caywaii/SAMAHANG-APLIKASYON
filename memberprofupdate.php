                        ...
                        <div class="card-body">
                            <div class="row mb-3">
	                         ...
	                         <div class="col-sm-9 text-secondary">
	                            <form action="memberprofupdatebio.php?uID=<?php echo $row['uID']; ?>" method="post">
                                        ...
                                        <a class="button_red btn" href="deletebiomem.php?uID=<?php echo $row['uID']; ?>" type="reset">Reset</a>
                                        <a class="btn-warning btn" href="memberprof.php">Cancel</a> 
                                        </form>
            					</div>
            				</div>
                        </div>
